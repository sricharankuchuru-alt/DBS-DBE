...
SELECT * FROM Books;#2520030093_Charan
...
SELECT * FROM Members;#2520030093_charan
CREATE TABLE Loans (
...
SELECT * FROM Loans;#2520030093_Charan
SELECT m.full_name AS Member_Name, b.title AS Book_Title
FROM Loans l
INNER JOIN Members m ON l.member_id = m.member_id
INNER JOIN Books b ON l.book_id = b.book_id;#2520030093_charan
...
COMMIT;#2520030093_Charan
CREATE INDEX idx_books_isbn ON Books(isbn);
SELECT * FROM Books WHERE isbn = '9780451524935';#2520030093_Charan
